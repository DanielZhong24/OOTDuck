...
function FilterSidebar({ onClick, isOpen, toggleOpen, setClothes }: FilterSidebarProps) {
  ...
  return (
    <aside
      className={`fixed top-0 right-0 bottom-0 z-50 flex h-screen w-full flex-col justify-between bg-white p-4 transition-transform duration-450 sm:w-[45%] lg:w-[30%] ${isOpen ? "translate-x-0" : "translate-x-[100vw]"}`}
    >
      <div>
