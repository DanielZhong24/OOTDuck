...
function Features() {
  return (
    ...
    >
      <div className="flex space-y-18 pb-12 sm:flex-col sm:px-4 md:flex-row md:items-center md:justify-evenly md:space-y-0 lg:justify-between">
        <div className="sm:max-w-[70%] md:max-w-[40%] lg:max-w-[45%] xl:max-w-[40%]">
          <div className="flex h-full flex-col space-y-6">
            <h3 className="sm:text-3xl lg:leading-12 xl:text-5xl xl:leading-14">
